      ...
      <table className={classes.table}>
        ...
        <tbody>
          <tr>
            ...
            <td>{+props.data.x.rms.toFixed(3)}</td>
            <td>{+props.data.y.rms.toFixed(3)}</td>
            <td>{+props.data.z.rms.toFixed(3)}</td>
          </tr>
          <tr>
            <td className={`${classes.name} ${classes.namecol}`}>
              Peak [m/s^2]:
            </td>
            <td>{+props.data.x.peak.toFixed(3)}</td>
            <td>{+props.data.y.peak.toFixed(3)}</td>
            <td>{+props.data.z.peak.toFixed(3)}</td>
          </tr>
          <tr>
            <td className={classes.name}>Kurtosis:</td>
            <td>{+props.data.x.kurtosis.toFixed(3)}</td>
            <td>{+props.data.y.kurtosis.toFixed(3)}</td>
            <td>{+props.data.z.kurtosis.toFixed(3)}</td>
          </tr>
          <tr>
            <td className={classes.name}>Crest factor:</td>
            <td>{+props.data.x.crestFactor.toFixed(3)}</td>
            <td>{+props.data.y.crestFactor.toFixed(3)}</td>
            <td>{+props.data.z.crestFactor.toFixed(3)}</td>
          </tr>
        </tbody>
      </table>
    </Card>
